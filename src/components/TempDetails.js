...
import { iconUrlFromCode,formatToLocalTime } from '../service/WeatherService'
function TempDetails({weather:{details,icon,temp,temp_min,temp_max,sunrise,sunset,speed,humidity,feels_like,timezone}}) {
  return (
    <div>
        ...
        <div className="flex flex-row items-center justify-center space-x-2 text-white text-sm py-3 mt-3">
            <UilSun/>
