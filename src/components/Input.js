...
function Input({setQuery,units,setUnits}) {
  ...
  const handleLocationClick=()=>{
    ...
    if(navigator.geolocation){
      toast.info('Fetching your loaction')
  ...
  return (
    <div className='flex flex-row justify-center my-6'>
        <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
            <input 
            value={city}
            onChange={(e)=>setCity(e.currentTarget.value)} type="text" placeholder='Search for City...' className='rounded-lg	 text-xl font-light p-2 shadow-xl w-full focus:outline-none capitalize placeholder:lowcase' />
